...
GET /categories?[query_param=value]: Retrieve categories that satisfy query parameters.<br />
...
GET /customers?[query_param=value]: Retrieve customers that satisfy query parameters.<br />
...
GET /employees?[query_param=value]: Retrieve employees that satisfy query parameters.<br />
...
GET /menu_items?[query_param=value]: Retrieve menu_items that satisfy query parameters.<br />
...
GET /orders?[query_param=value]: Retrieve orders that satisfy query parameters.<br />
